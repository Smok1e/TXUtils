...
Класс содержит 24 предопределённых статических цветов, которые можно получить подобно txu::Color::White. Ниже предоставлен список всех названий и цветов всех статических экземпляров:
