...
Я очень постарался, чтобы моя библиотека как можно меньше влияла на TXLib - на данный момент, включение TXUtils в программу никак не скажется на работе программы. Вы можете использовать TXLib как обычно.
