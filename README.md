...
- [txu::Time operator "" \_hour (long long unsigned hours]
...
- [txu::Time operator "" \_hour (long double hours]
...
mcsec возвращает микросекунды, \_msec - миллисекунды, \_sec - секунды, \_min - минуты, и \_hour - часы.
