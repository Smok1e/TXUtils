...
Класс содержит 25 предопределённых статических цветов, которые можно получить подобно txu::Color::White. Ниже предоставлен список всех названий и цветов всех статических экземпляров:
...
- [void txu::Font::setSize (Coord2D size)](font setsize coord2d https://github.com/Smok1e/TXUtils/blob/main/README.md#void-txufontsetsize-coord2d-size)
...
- [Coord2D txu::Font::getSize ()](font getsize coord2d https://github.com/Smok1e/TXUtils/blob/main/README.md#coord2d-txufontgetsize-)
